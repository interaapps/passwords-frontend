<template>
    <div id="password-sidebar" v-if="$store.state.currentPassword != null">
        <!-- <Modal :opened="false" >
            ...
            <input id="password-input" v-model="generatedPassword" type="text" readonly=true class="input" style="width: 100%" >
            <a @click="login" id="login-button" class="btn">USE THIS</a>
        </Modal> -->
...
export default {
    ...
    methods: {
        ...
        generatePassword(){
            ...
            this.generatedPassword = helper.randomString(letters, this.generatePasswordLength)
        },
        changed(){
