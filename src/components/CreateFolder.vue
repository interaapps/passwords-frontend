<template>
    <div>
        <Modal :opened="modalOpened" >
            <svg @click="modalOpened = false" id="close-button" width="30px" height="30px" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M11.854 4.146a.5.5 0 0 1 0 .708l-7 7a.5.5 0 0 1-.708-.708l7-7a.5.5 0 0 1 .708 0z"/><path fill-rule="evenodd" d="M4.146 4.146a.5.5 0 0 0 0 .708l7 7a.5.5 0 0 0 .708-.708l-7-7a.5.5 0 0 0-.708 0z"/></svg>
            <h3 class="title">Create Folder</h3>

            <input type="text" class="input" style="width: 100%" autocomplete="off" placeholder="name">
            <div id="color-picker">
            ...
            <a id="login-button" class="btn">CREATE FOLDER</a>
        </Modal>
    </div>
</template>
<script>
