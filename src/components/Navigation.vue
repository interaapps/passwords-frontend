<template>
    <div>
        <div id="sidenav" v-if="!(this.$store.state.app.fullScreenOnNotes && this.$route.name == 'Notes')">
            
            <router-link class="entry" :class="{selected: $route.name=='Passwords'}" to="/">
        ...
        <div id="nav" v-if="!(this.$store.state.app.fullScreenOnNotes && this.$route.name == 'Notes')">
            ...
            <div id="search" :class="{focused: searchOpened}">
                ...
                <div id="result">
                    ...
                    <div v-for="(folder, index) in folders" :key="'folder'+index">
                        <div class="result" v-if="searchMatch(folder.name)" @click="$router.push('/f/'+folder.id)">
